 ...
 */
export default function useManageHoverEvents(hoverTargetElement: Node, focused: boolean, disableDefaultEventHandling: boolean, onHoverStartCallback: () => void, onHoverEndCallback: () => void): void;
