import { VideoCaptionsTrack, VideoCaptionsProp } from '../HoverVideoPlayer.types';
/**
 ...
 */
export default function useFormatVideoCaptions(videoCaptions: VideoCaptionsProp): VideoCaptionsTrack[];
