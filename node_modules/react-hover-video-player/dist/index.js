...
function useFormatVideoSrc(videoSrc, playbackRangeStart, playbackRangeEnd) {
    var previousVideoSrc = React.useRef(null);
    var previousFormattedVideoSources = React.useRef(null);
...
function useHoverTargetElement(hoverTarget) {
    var _a = React.useState(null), hoverTargetElement = _a[0], setHoverTargetElement = _a[1];
    React.useEffect(function () {
...
function useManageHoverEvents(hoverTargetElement, focused, disableDefaultEventHandling, onHoverStartCallback, onHoverEndCallback) {
    ...
    var onHoverStartCallbackRef = React.useRef();
    onHoverStartCallbackRef.current = onHoverStartCallback;
    var onHoverEndCallbackRef = React.useRef();
    ...
    var previousFocusedRef = React.useRef(false);
...
function HoverVideoPlayer(_a) {
    ...
    var nextVideoStartTimeRef = React.useRef(null);
    ...
    var previousFormattedVideoSourcesRef = React.useRef(formattedVideoSources);
    /**
     ...
     */
    var attemptToPlayVideoRef = React.useRef();
     ...
     */
    var attemptToPauseVideoRef = React.useRef();
    ...
    return (React__default["default"].createElement("div", __assign({ "data-testid": "hover-video-player-container", ref: containerRef, style: __assign(__assign(__assign({}, containerSizingStyles[sizingMode]), { position: 'relative' }), style) }, spreadableProps),
        ...
        hasLoadingOverlay ? (React__default["default"].createElement("div", { style: __assign(__assign(__assign({}, expandToFillContainerStyle), { zIndex: 2, opacity: shouldShowLoadingOverlay ? 1 : 0, transition: "opacity ".concat(overlayTransitionDuration, "ms ").concat(shouldShowLoadingOverlay ? loadingStateTimeout : 0, "ms"), 
